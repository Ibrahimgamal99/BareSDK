# voxsdk_merge(OUTPUT <path> INPUTS <lib...> DEPENDS <target...>)
#
...
# A custom target "voxsdk" is added so `cmake --build . --target voxsdk` works.

function(voxsdk_merge)
  cmake_parse_arguments(_M "" "OUTPUT" "INPUTS;DEPENDS" ${ARGN})

  if(NOT _M_OUTPUT)
    message(FATAL_ERROR "voxsdk_merge: OUTPUT is required")
  endif()
  if(NOT _M_INPUTS)
    message(FATAL_ERROR "voxsdk_merge: INPUTS is required")
  endif()
  ...
  # -----------------------------------------------------------------------
    ...
    set(_MRI_FILE "${CMAKE_BINARY_DIR}/voxsdk_merge.mri")
  ...
  add_custom_target(voxsdk ALL DEPENDS "${_M_OUTPUT}")
endfunction()
