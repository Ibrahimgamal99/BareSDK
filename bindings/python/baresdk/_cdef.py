"""
_cdef.py — hand-written cffi cdef for baresdk public API.

This mirrors include/baresdk.h exactly.  Update here when the C header changes.
Using a hand-written cdef is more portable than a preprocessed header because
cffi's pycparser cannot handle all gcc/clang builtins and system typedefs.
"""
...
typedef struct { const char *message; } baresdk_ev_registrar_warning_t;
