"""
events.py — Python dataclasses mirroring VoxSDK event payloads.
...
class RegStateEvent:
    ...
    error: int           # VOXSDK_ERR_* or VOXSDK_OK
...
class IncomingCallEvent:
    ...
    call: object         # VoxSDK.Call (set by Account)
    from_uri: str
