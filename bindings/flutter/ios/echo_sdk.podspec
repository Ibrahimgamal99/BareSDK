#
# EchoSDK Flutter plugin — iOS.
#
# Vendors the prebuilt dynamic EchoSDK.xcframework (built on macOS/CI by
...
over dart:ffi.
                       DESC
  s.homepage         = 'https://github.com/NawyRE/echo-sdk'
  s.license          = { :type => 'BSD-3-Clause', :file => '../LICENSE' }
  s.author           = { 'EchoSDK' => 'noreply@example.com' }
  s.source           = { :path => '.' }

  s.platform         = :ios, '13.0'
  s.swift_version    = '5.0'
  s.source_files     = 'Classes/**/*'
  # EchoSDKExternalAudio.h must reach the generated umbrella header so the
  ...
  s.prepare_command = <<-CMD
    if [ ! -d Frameworks/EchoSDK.xcframework ]; then
      ...
      echo "into bindings/flutter/ios/Frameworks/EchoSDK.xcframework." >&2
      exit 1
    fi
  CMD
