 ...
 */
class VoxSDKPlugin : FlutterPlugin, MethodChannel.MethodCallHandler {
    ...
    override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
        ...
        channel = MethodChannel(binding.binaryMessenger, "vox_sdk")
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        when (call.method) {
            ...
            // harmless (platform_channel.dart, vox_sdk.dart, docs/api/media.md).
    ...
    // ── Network change → Dart → voxsdk_network_changed() ──────────────
